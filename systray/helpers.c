...
int request_property(DBusConnection* conn, const char* busname, const char* busobj, const char* prop, const char* iface,
					 PropHandler handler, void* data) {
	DBusMessage* msg = NULL;
	DBusPendingCall* pending = NULL;
	int r;

	if (!(msg = dbus_message_new_method_call(busname, busobj, DBUS_INTERFACE_PROPERTIES, "Get")) ||
